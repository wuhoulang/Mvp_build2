...
public class DJ_FloatView extends android.support.v7.widget.AppCompatImageView {
	//	private float mX;
...
//	private DJ_PreferebceManager mPreferenceManager = null;
//	private Context context;
	...
	public DJ_FloatView(Context context, LayoutParams windowManagerParams, WindowManager windowManager) {
		super(context);
//		this.context = context;
		image = this;
		this.windowManager = windowManager;

//		defaultResource = DJ_Utils.getDrawableId(context, "roundone");
//	    darkResource =  DJ_Utils.getDrawableId(context, "roundone");
//		leftResource = DJ_Utils.getDrawableId(context, "roundone");
//		rightResource = DJ_Utils.getDrawableId(context, "roundone");
...
//		mPreferenceManager = new DJ_PreferebceManager(context);
//		windowManagerParams.type = LayoutParams.TYPE_PHONE;
		...
		windowManagerParams.type = LayoutParams.LAST_APPLICATION_WINDOW;
		...
		public void handleMessage(android.os.Message msg) {
			switch (msg.what) {
				...
				case MOVE_SLOWLY:
					...
					break;
				case FADE_OUT:
					ObjectAnimator.ofFloat(DJ_FloatView.this, "alpha",
...
//				mPreferenceManager.setFloatY(y-mTouchY);
...
//	public void setNoDuplicateClickListener(DJ_NoDuplicateClickListener l) {
...
//			windowManagerParams.windowAnimations = android.R.anim.slide_in_left;
			...
			Log.e("Params","x:"+x);
			Log.e("Params","y:"+x);
			Log.e("Params","mTouchX:"+mTouchX);
			Log.e("Params","mTouchY:"+mTouchY);
			windowManagerParams.y = (int) (y - mTouchY);
